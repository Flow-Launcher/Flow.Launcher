...
namespace Flow.Launcher.Test
{
    ...
    internal class MainViewModelPreviewTest
    {
        ...
        [Test]
        public async Task GivenPreviewHidden_WhenContentBlocksResultWithDefaultVisibilitySelected_ThenInternalPreviewStaysHidden_Async()
        {
            // Content blocks only control rendering; they must not force the pane open.
            ...
            viewModel.PreviewSelectedItem = new ResultViewModel(
                new Result
                {
                    Title = "Markdown",
                    PreviewVisibility = PreviewVisibility.Optional,
                    RichPreview = new Result.RichPreviewInfo
                    {
                        ContentBlocks = [new MarkdownPreviewBlock { InlineMarkdown = "# Title" }]
                    }
