...
{
    public static readonly DiagnosticDescriptor CouldNotFindResourceDictionaries = new(
        "FLSG0001",
    ...
    public static readonly DiagnosticDescriptor CouldNotFindPluginEntryClass = new(
        "FLSG0002",
    ...
    public static readonly DiagnosticDescriptor CouldNotFindContextProperty = new(
        "FLSG0003",
    ...
    public static readonly DiagnosticDescriptor ContextPropertyNotStatic = new(
        "FLSG0004",
    ...
    public static readonly DiagnosticDescriptor ContextPropertyIsPrivate = new(
        "FLSG0005",
    ...
    public static readonly DiagnosticDescriptor ContextPropertyIsProtected = new(
        "FLSG0006",
    ...
    public static readonly DiagnosticDescriptor LocalizationKeyUnused = new(
        "FLSG0007",
